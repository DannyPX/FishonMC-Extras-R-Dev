...
public class EditFieldListWidget extends ClickableWidget implements ScreenConstants {
    ...
    public EditFieldListWidget(int x, int y, int width, int height, Text header) {
    ...
    private LineEntry getDefaultEntry() {
        return new EditFieldListWidget.LineEntry(
                "Example text",
                false,
                false,
                getDefaultCallback()
